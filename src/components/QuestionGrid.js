  ...
  return props.displayState === false ? (
    ...
    <div className="Question-Grid">
      ...
      <div className="box-container">
        <ColorBox
          color={props.Info.randomColors[0]}
          opacity={props.colorChange}
        />
        <p>{props.Info.realColorsArray[0]}</p>
        <ColorBox
          color={props.Info.randomColors[1]}
          opacity={props.colorChange}
        />
        <p>{props.Info.randomColors[1]}</p>
        <ColorBox
          color={props.Info.randomColors[2]}
          opacity={props.colorChange}
        />
        <p>{props.Info.randomColors[2]}</p>
      </div>
    </div>
  );
};
